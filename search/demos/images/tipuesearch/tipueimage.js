                         ...
                         if (c != 0)
                         {
                              ...
                              for (var i = 0; i < found.length; i++)
                              {
                                   ...
                                   if (l_o >= start && l_o < set.show + start)
                                   {
                                        ...
                                        out += '<div class="tipue_search_box_but_wrap"><div style="float: left; margin-right: 13px;"><a class="tipue_search_box_but" href="' + fo[5] + '"' + tipue_search_w + '>Go to page</a></div>';
                                        out += '<div style="float: left;"><a class="tipue_search_box_but" href="' + fo[2] + '"' + tipue_search_w + '>Full size</a></div><div style="clear: both;"></div></div>';
                                        out += '</div>';
                                   }
                                   l_o++;     
                              }
